...
3. Escribe un programa que pide un número entero, luego pide otro número entero. El programa calcula la división entre ambos números y lmuestra el resultado en pantalla. Captura la excepción ArithmeticException al hacer la división y muestra el mensaje "No se puede dividir por 0" en dicho caso.
